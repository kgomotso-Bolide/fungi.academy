...
(function(){
  ...
  var SKILLS=[
    ...
    {k:'data',  n:'Data &amp; spreadsheets',          l:'data and spreadsheets',
     d:'Readings, exports, formulas — getting numbers into a usable shape'},
    {k:'tech',  n:'Metering &amp; technical systems', l:'metering and technical systems',
     d:'Meters, installs, fault-finding, the vending platform'},
    {k:'comms', n:'Customer &amp; written comms',     l:'customer and written communication',
     d:'Explaining a bill, a fault or an outcome so it lands first time'},
  ...
  var ROLES=[
    {k:'metering',n:'Metering Technician',           t:{ai:3,data:3,tech:4,comms:2,report:2,admin:3,resp:3,lead:1}},
    {k:'field',   n:'Field Operations',              t:{ai:3,data:2,tech:3,comms:3,report:2,admin:3,resp:3,lead:2}},
    {k:'billing', n:'Billing &amp; Revenue',             t:{ai:3,data:4,tech:2,comms:3,report:4,admin:3,resp:4,lead:1}},
  ...
  var BACKGROUNDS=[
    {k:'utilities',n:'Utilities / energy'},
  ...
  /* Course catalogue with the skills each one moves. Slugs match course.html.
     ...
     nothing in a utility, so recommending them would be noise. */
  var COURSES=[
  ...
  function analyse(a){
    ...
    var techRole=['metering','field','datasys'].indexOf(a.role)>=0;
  ...
  function rplCase(rows,qual,yrs){
    ...
    if(byK.data&&byK.data.self>=3) ev.push('Readings, exports or spreadsheets you built that other people rely on');
