...
(function(){
  ...
  var P=window.FungiProfile;

  var FIELDS=['name','empno','dept','manager','email','phone','role','years','qual','bg'];
  function el(k){ return document.getElementById('pf-'+k); }

  var ROLE_NAMES={metering:'Metering Technician',field:'Field Operations',billing:'Billing & Revenue',
  ...
  form.addEventListener('submit',function(ev){
    ...
    window.dispatchEvent(new Event('fungi-profile-changed'));
